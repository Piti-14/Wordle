...
var _Game_secretWord, _Game_userWord, _Game_attempt, _Game_actualPosition, _Game_userInterface;
...
export class Game {
    ...
    updateLetterColors() {
        ...
        __classPrivateFieldGet(this, _Game_userInterface, "f").changeBackgroundKeyColor(__classPrivateFieldGet(this, _Game_userWord, "f"));
    }
}
_Game_secretWord = new WeakMap(), _Game_userWord = new WeakMap(), _Game_attempt = new WeakMap(), _Game_actualPosition = new WeakMap(), _Game_userInterface = new WeakMap();
